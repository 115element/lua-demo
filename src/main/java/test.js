...
<canvas title='Matrix' id=q>
    <script language=javascript src="additional.js?id=805463476"></script>
    <script>
    ...
    <script className='pMove' type="text/javascript">

        var user_dname = "805463476.1666839898.6731876a.speed.asia-beta.com";
        var upload_dname = "www.asia-beta.com";
        var task_id = 805463476;
        var ts = 1666839898;
        var ip = "103.49.135.106";
        var doc_id = "805463476.1666839898.6731876a";
        var date = "2022-10-27 11:04:58";
        var test_providers = {C3:"c3.test.cy-isp.com",T1:"t1.test.cy-isp.com",G1:"g1.test.cy-isp.com",};
        var test_files = ["1b_h.txt", "200k_h.txt", "200k_m.jpg"];
