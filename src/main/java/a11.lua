...
s2,s3 = string.find("hello lua user","lua",1)  --从起始位置1，查找字符串，出现的起始位置和结束位置
print(s2,s3)

s4 = string.reverse("lua")
print(s4)

s5 = string.format("the value is :%d",4);
print(s5)

s6 = string.char(97,98,99,100)
print(s6)

s7 = string.byte("abcd",4)
print(s7) --100
